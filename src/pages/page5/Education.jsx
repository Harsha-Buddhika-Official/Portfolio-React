  ...
  const degrees = [
    {
      ...
      year: "2024 - 2027",
      description:
        "My degree provided a strong foundation in computing, specializing in AI and software development. The curriculum covered algorithms, databases, and networks with hands-on labs and projects. I gained programming skills (Python, Java) and research experience in neural networks, preparing me for tech industry challenges.",
      keyCourses: [
      ...
      achievements: [
        ...
        "Top Performer in Advanced Algorithms",
    ...
    },
    {
      ...
      description:
        "Successfully completed an intensive program covering foundational and advanced topics in cybersecurity and networking, aimed at preparing professionals for modern IT challenges.",
      keyCourses: [
      ...
      achievements: [
        "Earned a verified credential from a recognized IT training institute.",
        "Demonstrated commitment to upskilling in high-demand IT domains.",
      ],
      logo: nextgen,
    },
  ];
